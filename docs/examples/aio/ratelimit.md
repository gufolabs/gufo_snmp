...
See [SnmpSession.getbulk() reference][gufo.snmp.aio.SnmpSession.getbulk]
for further details. 
...
and pass the address, community, and OID as command-line parameters.
...
```
$ python3 examples/aio/ratelimit.py 127.0.0.1 public 1.3.6.1.2.1.1
