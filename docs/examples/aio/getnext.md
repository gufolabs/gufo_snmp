...
See [SnmpSession.getnext() reference][gufo.snmp.aio.SnmpSession.getnext]
for further details. 
...
```
$ python3 examples/aio/getnext.py 127.0.0.1 public 1.3.6.1.2.1.1
